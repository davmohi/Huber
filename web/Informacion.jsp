...
<div class="container-fluid bg-grey">
  <div class="row">
    ...
    <div id="valores" class="col-sm-8">
      <h2>Valores</h2><br>
      <h4><strong>MISIÓN:</strong>s.</h4><br>
      <p><strong>VISIÓN:</strong>s</p>
    </div>
  </div>
</div>
...
<div id="portfolio" class="container-fluid text-center bg-grey">
  ...
  <div id="myCarousel" class="carousel slide text-center" data-ride="carousel"> <!-- Wrapper for slides -->
    <div class="carousel-inner">
      ...
      <div class="item">
        <h4>"No podría estar más feliz con este compañía"<br><span>Alonso Morgan, Jugador de Snooker,UK </span></h4>
      </div>
    </div>
